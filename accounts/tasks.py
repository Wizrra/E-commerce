...
# #OTP MAIL SENDING TASK
# @shared_task(name="send_otp_email_task")
# def send_otp_email(email, otp, username=None):
  
  
#   current_year = timezone.now().year
#   html_content = render_to_string("emails/send_email_otp.html", {"user_name": username, "otp": otp, "current_year": current_year})
...
#   if count:
#     expired_otps.delete()
#     logger.info(f"Deleted %d expired OTPs older than %s", count, cutoff.isoformat())
#   else:
